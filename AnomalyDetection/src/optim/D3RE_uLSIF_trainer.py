...
class D3REuLSIFTrainer(BaseTrainer):

    def __init__(self, upper_bound, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 150,
    ...
    def train(self, dataset: BaseADDataset, net: BaseNet):
        ...
        for epoch in range(self.n_epochs):
            ...
            for data in train_loader:
                ...
                loss_nu = ((-2*outputs+outputs**2/self.upper_bound)*t_nu).sum()/n_nu
                loss_nu_middle = (-outputs**2*t_nu/self.upper_bound).sum()/n_nu
