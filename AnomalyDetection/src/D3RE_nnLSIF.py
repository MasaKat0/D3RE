...
class D3REnnLSIF(object):
    ...
    def train(self, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 50,
        ...
        self.trainer = D3REnnLSIFTrainer(self.upper_bound, optimizer_name=optimizer_name, lr=lr, n_epochs=n_epochs,
    ...
    def test(self, dataset: BaseADDataset, device: str = 'cuda', n_jobs_dataloader: int = 0):
        ...
        if self.trainer is None:
            self.trainer = D3REnnLSIFTrainer(self.pi, device=device, n_jobs_dataloader=n_jobs_dataloader)
